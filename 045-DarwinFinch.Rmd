...
* The orderings of variables and categories in parallel coordinate plots makes a big difference to what can be seen.\index{ordering}  (Figure \@ref(fig:snodPCP))
