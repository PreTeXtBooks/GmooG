...
These six countries actually accounted for `r round(100*sum(p16$p2016)/sum(pops$p2016),1)`% of the total world population in 2016.  It is interesting to see how that changed over time, cf. Figure \@ref(fig:LEtop6p).  If the nineteenth century population figures for China are to be believed, if indeed any of the population figures from that period are to be believed, China used to be relatively far bigger!
