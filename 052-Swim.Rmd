...
The times for the events are almost completely separated. There is a possible overlap between the fastest butterfly time and the slowest freestyle times. In fact the best time for the butterfly was `r as.numeric(All200 %>% filter(dist==50, Gender=="Men", Style=="Butterfly") %>% summarise(mint=min(SwimTime)))` seconds and the two-hundredth best time for the freestyle was `r as.numeric(All200 %>% filter(dist==50, Gender=="Men", Style=="Freestyle") %>% summarise(maxt=max(SwimTime)))` seconds. Three of the four plots have the same patterns seen in Figure \@ref(fig:swM100f), a few fine older performances, a string of best times with full body swimsuits in 2009, and a gradual improvement over the past 10 years from the slower times recorded in 2010.  There are two exceptions.  One is the 50 m backstroke time of Camille Lacourt in 2010.  The other is the extraordinary time of Adam Peaty in the 50 m breaststroke in 2017.  Unlike in the other events, several breaststroke swimmers have beaten the best full body swimsuit time.  Was it of less benefit to breaststroke swimmers?
